...
# Abstract
**Introduction:** Venom induced anaphylaxis (VIA) is a common, potentially life-threatening hypersensitivity reaction associated with specific: 1) symptom profile, 2) cofactors, and 3) management. Identifying the differences in subtypes of anaphylaxis is crucial for future management guidelines and the development of a personalized medicine approach.  

**Aim:** This study aimed to evaluate the phenotype and risk factors of venom induced anaphylaxis in comparison to other elicitors of anaphylaxis.

**Methods:** Using data from the European Anaphylaxis Registry (`r nrow(data)` cases) we identified `r length(which(data4$d_elicitor_gr5== "insects" & data4$reaction_type_brown=="anaphylaxis"))` with VIA and analyzed these in comparison to sex-and-age-matched anaphylaxis cases triggered by other elicitors (non-VIA n = `r nrow(age_sex_matched %>% filter(grouping == "other"))`).

**Results:** Venom induced anaphylaxis (VIA) more frequently involved more than three organ systems and was associated with cardiovascular symptoms. The absence of skin symptoms during anaphylaxis correlated with baseline serum tryptase (BST) and was associated with an increased risk of a severe reaction. Intramuscular or intravenous adrenaline was administered significantly less often in VIA, in particular in patients without prior history of anaphylaxis. BST (8-11.5 ng/ml) was more frequently associated with severe anaphylaxis compared to BST values of < 8 ng/ml.

**Conclusions:** Regarding the fact that VIA frequently affects the cardiovascular system, VIA patients were undertreated with adrenaline. The lack of skin symptoms (i.e. urticaria or flushing) during anaphylaxis (especially in combination with BST levels within upper normal limits) is associated with severe reactions. 

# Introduction

Hypersensitivity to insect venom presents as a systemic reaction (anaphylaxis) in up to 0.3--7.5% of the adult population [@Bil2008]. Venom induced anaphylaxis (VIA) can be fatal, and patients sometimes require lifelong venom immunotherapy [@Sturm2017]. There is a need for a more precise description of the diagnosis, identification of biomarkers, and better definition of phenotypes of anaphylaxis [@JimenezRodriguez2018]. Nevertheless, in order to facilitate a precision-medicine approach [@Muraro2017] for the diagnosis of anaphylaxis --- a better understanding of its clinical subtypes is required.

Anaphylaxis is a clinical diagnosis with a variety of trigger factors and clinical presentations. Symptom profiles and specific cofactors for venom-induced anaphylaxis (VIA) had previously been analyzed in an uncontrolled manner albeit relatively small cohorts [@LANTNER; @Ruff2009; @nittner2015insect]. 
...
Although the pattern of organ involvement during anaphylaxis in both groups showed similarities in gastrointestinal, skin, and respiratory systems, VIA more frequently involved more than three organ systems (`r compare(c(tempdf[3:4,">3 organ\nsystems"]))`,<!-- , and did not differ in the proportion of elevated baseline serum tryptase (> 8 ng/ml). Although, patients undergoing VIA  less often had concomitant atopic diseases  -->
...
Next, we investigated the association of skin symptoms with the tryptase levels in non-mastocytosis patients. For this model, we excluded the cases with known mastocytosis and with BST above 11.5 ng/ml, potentially indicating non-diagnosed mastocytosis. Similarly, 1) tryptase levels were higher in VIA patients, 2) correlated with the severity of anaphylaxis, and 3) this effect was significant in VIA (`r skin_symptoms$fit_tryp[[1]][4,5] %>% pval()`) but not in the non-VIA group (Fig. \@ref(fig:figskinsymptoms)C-D).
...
## Venom anaphylaxis is a seasonal disease (may be moved to supplement).
...
In this study, we identified distinct symptom-profile and treatment patterns of venom-induced anaphylaxis. The data unravel phenotypes of VIA, which may support the development of tools incorporating clinical <!--- and biomarker--->data for predicting the severity of future episodes of anaphylaxis.
...
Importantly, the absence of skin symptoms was associated with more severe VIA, which was still present after excluding patients with a known diagnosis of mastocytosis. Subsequently, the correlation of BST levels with severity of anaphylaxis lead us to identify an interaction between the absence of skin symptoms and VIA using generalized linear regression.

Our findings indicate that patients with BST of over 8 ng/ml are prone to severe anaphylaxis to insect venom. Patients with normal BST in the range of 8-11.4 ng/ml may have indolent systemic mastocytosis or concomitant undiagnosed mast cell activation syndrome (MCAS) [@Valent2019]. Zanotti et al. identified mast cell disorders in 17 out of 22 patients with VIA lacking skin symptoms  and concluded that patients with BST of 7.95 ng/ml and VIA should undergo extensive diagnostic procedures [@Zanotti2015]. We recently identified that elderly patient undergoing anaphylaxis without concomitant skin symptoms tended to have more severe reactions [@Aurich2019]
...
Adult patients experienced VIA more frequently. Young patients mainly suffer from food-induced anaphylaxis [@Grabenhenrich2016]. 
...
Similarly, we observed less VIA in patients with concomitant atopic diseases (Fig. ) , as these patients more often present with food anaphylaxis [@Tham2019]. 
...
```{r sup_cofactors, fig.cap="Cofactors of anaphylaxis."}
