...
> Francuzik et al. , (2019). _Insect Venom Anaphylaxis, observetional study of the European Anaphylaxis Registry_. Name of journal/book <https://doi.org/xxx/xxx>
...
> Authors, (`r format(Sys.Date(), "%Y")`). _Compendium of R code and data for 'Insect Venom Anaphylaxis, observetional study of the European Anaphylaxis Registry'_. Accessed `r format(Sys.Date(), "%d %b %Y")`. Online at <https://doi.org/xxx/xxx>
